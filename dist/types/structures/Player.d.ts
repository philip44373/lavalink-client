...
export declare class Player {
     ...
     * @param requestUser
     */
    search(query: SearchQuery, requestUser: unknown, throwOnEmpty?: boolean): Promise<import("./Types/Utils").UnresolvedSearchResult | import("./Types/Utils").LavaSearchResponse | import("./Types/Utils").SearchResult>;
    /**
     * Pause the player
     */
    pause(): Promise<this>;
